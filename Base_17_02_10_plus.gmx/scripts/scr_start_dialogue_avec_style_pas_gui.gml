///scr_start_dialogue_avec_style_pas_gui(path, target||[-1], inst_dialogue_style||[-1], inst_activable_pour_cooldown||[-1])
...
var dessine = instance_create(-99999,-99999,obj_dialogue_dessine_pas_gui);
if (-1 != argument2)
{
