#define scr_conditional_execute_with_callables
///scr_conditional_execute_with_callables(condition, execute, is_persistent)
...
#define scr_conditional_execute_with_callables_2
///scr_conditional_execute_with_callables_2(condition, execute1, execute2, is_persistent)
var cond = instance_create(0,0, obj_conditional_execute);
cond.condition = scr_execute(argument0);
cond.executes[0] = scr_execute(argument1);
