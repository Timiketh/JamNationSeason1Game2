///scr_sprite_droite(id)
var startPoint = argument0.x;

if (!instance_exists(argument0))
{
    scr_erreur("L'argument0 dans scr_sprite_droite n'est pas une instance qui existe.");   
}

var offsetY = (argument0.sprite_height - argument0.sprite_yoffset);
var offsetX = argument0.sprite_xoffset;
...
{
    offsetY = argument0.sprite_yoffset;
}
if ((!xscale && condition1) || (!condition1 && xscale))
{
    offsetX = argument0.sprite_width - argument0.sprite_xoffset;
}
